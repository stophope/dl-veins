...
const Coord& ReportMessage::getSenderPos() const
{
...
const LAddress::L2Type& ReportMessage::getSenderAddress() const
{
...
ReportMessageDescriptor::ReportMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(veins::ReportMessage)), "veins::BaseFrame1609_4")
{
